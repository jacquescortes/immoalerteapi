...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SpecificationApiBackendImmoAlertefr.ApiClient = factory(root.superagent);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.immoalerte.fr/v1
     */
    this.basePath = 'https://api.immoalerte.fr/v1'.replace(/\/+$/, '');
