...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpecificationApiBackendImmoAlertefr.Stats();
  });
  ...
  describe('Stats', function() {
    it('should create an instance of Stats', function() {
      ...
      //var instane = new SpecificationApiBackendImmoAlertefr.Stats();
      //expect(instance).to.be.a(SpecificationApiBackendImmoAlertefr.Stats);
    });
